...
@section('content')
	...
	<div class="hug hug-header">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <a href="{{ route('home') }}" class="pull-left"><img src="{{ \App\Helpers\Helpers::logoUrl() }}" alt="AMA"></a>
    ...
    <div class="hug hug-hero">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="left-side">
                        <h1>Introducing AMA 2.0</h1>
                        <h2>An enterprise solution for project management system.</h2>
    ...
    <div class="hug hug-features">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h2 class="text-center">AMA comes full of delightful features!</h2>
                </div>
    ...
    <div class="hug hug-exit">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="img">
                        <h2>"Elegant, sexy, and enterprise solution for project management. I think it's time for you to take the dive."</h2>
                        <a href="{{ route('register') }}" class="btn btn-special">GET STARTED</a>
                    </div>
                </div>
            </div>
